				...
				if(_g._hx_index == 33) {
					...
					if(this.match(bh_multianim__$MacroManimParser_MacroTokenType.TComma)) {
						...
						if(_g._hx_index == 33) {
							...
							if(this.scopeVars.indexOf(indexVar2) == -1) {
...
var bh_multianim_MultiAnimParser = function() { };
bh_multianim_MultiAnimParser.__name__ = true;
...
manim_lsp_CompletionProvider.topLevelCompletions = function() {
	return [manim_lsp_CompletionProvider.snippet("programmable","#name programmable($1) {\n\t$0\n}","Define a programmable UI component"),manim_lsp_CompletionProvider.snippet("data","#name data {\n\t$0\n}","Define a typed data block"),manim_lsp_CompletionProvider.snippet("curves","curves {\n\t$0\n}","Define curve functions"),manim_lsp_CompletionProvider.snippet("paths","paths {\n\t$0\n}","Define path shapes"),manim_lsp_CompletionProvider.snippet("animatedPath","#name animatedPath {\n\t$0\n}","Define an animated path"),manim_lsp_CompletionProvider.snippet("import","import \"$1\" as \"$2\"","Import external .manim file"),manim_lsp_CompletionProvider.snippet("@final","@final $1 = $0","Define an immutable constant"),manim_lsp_CompletionProvider.kw("version:","File version header"),manim_lsp_CompletionProvider.snippet("atlas2","#name atlas2(\"$1\") {\n\t$0\n}","Inline sprite atlas"),manim_lsp_CompletionProvider.snippet("palette","#name palette {\n\t$0\n}","Color palette")];
};
manim_lsp_CompletionProvider.elementCompletions = function() {
	return [manim_lsp_CompletionProvider.kw("bitmap","Display image: bitmap(source, [center])"),manim_lsp_CompletionProvider.kw("text","Text element: text(font, text, color, [align, maxWidth])"),manim_lsp_CompletionProvider.kw("richText","Rich text with markup: richText(font, text, color, [align, maxWidth])"),manim_lsp_CompletionProvider.kw("ninepatch","9-patch scalable: ninepatch(sheet, tile, w, h)"),manim_lsp_CompletionProvider.kw("flow","Layout flow container"),manim_lsp_CompletionProvider.kw("layers","Z-ordering container"),manim_lsp_CompletionProvider.kw("mask","Clipping mask: mask(w, h)"),manim_lsp_CompletionProvider.kw("tilegroup","Optimized tile grouping"),manim_lsp_CompletionProvider.kw("interactive","Hit-test region: interactive(w, h, id)"),manim_lsp_CompletionProvider.snippet("slot","#name slot","Swappable container"),manim_lsp_CompletionProvider.kw("spacer","Empty space: spacer(w, h)"),manim_lsp_CompletionProvider.kw("point","Positioning point"),manim_lsp_CompletionProvider.kw("apply","Apply properties to parent"),manim_lsp_CompletionProvider.kw("graphics","Vector graphics"),manim_lsp_CompletionProvider.kw("pixels","Pixel primitives"),manim_lsp_CompletionProvider.snippet("particles","particles {\n\t$0\n}","Particle effect"),manim_lsp_CompletionProvider.kw("repeatable","Loop elements: repeatable($var, iterator)"),manim_lsp_CompletionProvider.kw("repeatable2d","2D loop: repeatable2d($x, $y, iterX, iterY)"),manim_lsp_CompletionProvider.kw("staticRef","Static embed: staticRef($ref)"),manim_lsp_CompletionProvider.kw("dynamicRef","Dynamic embed: dynamicRef($ref, params)"),manim_lsp_CompletionProvider.kw("placeholder","Dynamic placeholder"),manim_lsp_CompletionProvider.kw("stateanim","State animation"),manim_lsp_CompletionProvider.snippet("settings","settings {\n\t$0\n}","Component settings block"),manim_lsp_CompletionProvider.snippet("transition","transition {\n\t$0\n}","Animated parameter transitions"),manim_lsp_CompletionProvider.kw("filter:","Apply visual filter"),manim_lsp_CompletionProvider.kw("blendMode:","Set blend mode"),manim_lsp_CompletionProvider.kw("scale:","Set scale"),manim_lsp_CompletionProvider.kw("alpha:","Set alpha/opacity"),manim_lsp_CompletionProvider.kw("rotation:","Set rotation"),manim_lsp_CompletionProvider.kw("tint:","Set color tint"),manim_lsp_CompletionProvider.kw("layer:","Set render layer"),manim_lsp_CompletionProvider.snippet("@final","@final $1 = $0","Define a constant")];
};
...
manim_lsp_CompletionProvider.particleCompletions = function() {
	return [manim_lsp_CompletionProvider.kw("count","Number of particles"),manim_lsp_CompletionProvider.kw("emit","Emission shape: point|cone|box|circle|path"),manim_lsp_CompletionProvider.kw("tiles","Particle tile: file(\"img.png\") or sheet(\"atlas\", \"tile\")"),manim_lsp_CompletionProvider.kw("loop","Loop emission: true|false"),manim_lsp_CompletionProvider.kw("maxLife","Maximum particle lifetime (seconds)"),manim_lsp_CompletionProvider.kw("speed","Initial particle speed"),manim_lsp_CompletionProvider.kw("speedRandom","Speed randomization (0-1)"),manim_lsp_CompletionProvider.kw("gravity","Gravity strength"),manim_lsp_CompletionProvider.kw("gravityAngle","Gravity direction (degrees)"),manim_lsp_CompletionProvider.kw("size","Particle size multiplier"),manim_lsp_CompletionProvider.kw("sizeRandom","Size randomization (0-1)"),manim_lsp_CompletionProvider.kw("blendMode","Blend mode: add|alpha"),manim_lsp_CompletionProvider.kw("fadeIn","Fade-in duration (0-1 of life)"),manim_lsp_CompletionProvider.kw("fadeOut","Fade-out start (0-1 of life)"),manim_lsp_CompletionProvider.kw("colorStops","Color gradient: 0.0 #FF0000, 1.0 #0000FF"),manim_lsp_CompletionProvider.kw("sizeCurve","Size animation curve"),manim_lsp_CompletionProvider.kw("velocityCurve","Velocity animation curve"),manim_lsp_CompletionProvider.kw("forceFields","Force fields: [turbulence, wind, vortex, ...]"),manim_lsp_CompletionProvider.kw("bounds","Particle bounds: kill, box(...)"),manim_lsp_CompletionProvider.kw("rotationSpeed","Rotation speed (degrees/sec)"),manim_lsp_CompletionProvider.kw("rotateAuto","Auto-rotate to velocity: true|false"),manim_lsp_CompletionProvider.kw("relative","Relative to emitter: true|false"),manim_lsp_CompletionProvider.kw("spawnCurve","Spawn rate curve"),manim_lsp_CompletionProvider.kw("forwardAngle","Forward direction: down|up|right|left"),manim_lsp_CompletionProvider.kw("animFile","Animation file for particles"),manim_lsp_CompletionProvider.kw("subEmitters","Sub-emitter definitions")];
};
manim_lsp_CompletionProvider.curvesBodyCompletions = function() {
	return [manim_lsp_CompletionProvider.snippet("curve","#name curve {\n\t$0\n}","Define a named curve")];
};
manim_lsp_CompletionProvider.curveCompletions = function() {
	return [manim_lsp_CompletionProvider.kw("easing","Built-in easing function"),manim_lsp_CompletionProvider.kw("points","Control points: [(0, 0), (0.5, 1.0), (1.0, 0)]"),manim_lsp_CompletionProvider.kw("multiply","Multiply curves: [curve1, curve2]"),manim_lsp_CompletionProvider.kw("apply","Apply composition: inner, outer"),manim_lsp_CompletionProvider.kw("invert","Invert curve: 1.0 - curve(t)"),manim_lsp_CompletionProvider.kw("scale","Scale curve: curve, factor")];
};
manim_lsp_CompletionProvider.pathCompletions = function() {
	return [manim_lsp_CompletionProvider.kw("moveTo","Move to point: moveTo(x, y)"),manim_lsp_CompletionProvider.kw("lineTo","Line to point: lineTo(x, y)"),manim_lsp_CompletionProvider.kw("bezier","Cubic bezier: bezier(cp1x, cp1y, cp2x, cp2y[, endx, endy])"),manim_lsp_CompletionProvider.kw("quadratic","Quadratic curve: quadratic(cpx, cpy, endx, endy)"),manim_lsp_CompletionProvider.kw("arc","Arc segment"),manim_lsp_CompletionProvider.kw("close","Close path")];
};
manim_lsp_CompletionProvider.animatedPathCompletions = function() {
	return [manim_lsp_CompletionProvider.kw("path","Path reference (required)"),manim_lsp_CompletionProvider.kw("type","Animation type: time|distance"),manim_lsp_CompletionProvider.kw("duration","Duration in seconds"),manim_lsp_CompletionProvider.kw("speed","Speed (pixels/sec, for distance type)"),manim_lsp_CompletionProvider.kw("loop","Loop animation: true|false"),manim_lsp_CompletionProvider.kw("pingPong","Ping-pong: true|false"),manim_lsp_CompletionProvider.kw("easing","Easing function"),manim_lsp_CompletionProvider.kw("scaleCurve","Scale animation curve"),manim_lsp_CompletionProvider.kw("alphaCurve","Alpha animation curve"),manim_lsp_CompletionProvider.kw("rotationCurve","Rotation animation curve"),manim_lsp_CompletionProvider.kw("speedCurve","Speed animation curve"),manim_lsp_CompletionProvider.kw("progressCurve","Progress animation curve"),manim_lsp_CompletionProvider.kw("colorCurve","Color curve: curve, startColor, endColor"),manim_lsp_CompletionProvider.snippet("event","event(\"$1\")","Path event at rate"),manim_lsp_CompletionProvider.snippet("custom","custom(\"$1\"): $0","Custom value curve")];
};
manim_lsp_CompletionProvider.settingsCompletions = function() {
	return [manim_lsp_CompletionProvider.kw("buildName","Programmable build name override"),manim_lsp_CompletionProvider.kw("font","Font name"),manim_lsp_CompletionProvider.kw("fontColor","Font color"),manim_lsp_CompletionProvider.kw("width","Width"),manim_lsp_CompletionProvider.kw("height","Height"),manim_lsp_CompletionProvider.kw("text","Text content"),manim_lsp_CompletionProvider.kw("disabled","Disabled state")];
};
manim_lsp_CompletionProvider.transitionCompletions = function() {
	return [manim_lsp_CompletionProvider.kw("none","No transition (instant)"),manim_lsp_CompletionProvider.snippet("fade","fade($1, $2)","Fade transition: fade(duration, easing)"),manim_lsp_CompletionProvider.snippet("crossfade","crossfade($1, $2)","Crossfade: crossfade(duration, easing)"),manim_lsp_CompletionProvider.snippet("flipX","flipX($1, $2)","Horizontal flip: flipX(duration, easing)"),manim_lsp_CompletionProvider.snippet("flipY","flipY($1, $2)","Vertical flip: flipY(duration, easing)"),manim_lsp_CompletionProvider.snippet("slide","slide($1, $2)","Slide: slide(direction, duration)")];
};
manim_lsp_CompletionProvider.filterCompletions = function() {
	return [manim_lsp_CompletionProvider.kw("outline","Outline filter: outline(size, color)"),manim_lsp_CompletionProvider.kw("glow","Glow filter: glow(color, alpha, radius)"),manim_lsp_CompletionProvider.kw("blur","Blur filter: blur(radius)"),manim_lsp_CompletionProvider.kw("saturate","Saturation: saturate(value)"),manim_lsp_CompletionProvider.kw("brightness","Brightness: brightness(value)"),manim_lsp_CompletionProvider.kw("grayscale","Grayscale: grayscale(value)"),manim_lsp_CompletionProvider.kw("hue","Hue shift: hue(value)"),manim_lsp_CompletionProvider.kw("dropShadow","Drop shadow filter"),manim_lsp_CompletionProvider.kw("pixelOutline","Pixel-perfect outline"),manim_lsp_CompletionProvider.kw("replacePalette","Palette replacement"),manim_lsp_CompletionProvider.kw("replaceColor","Color replacement"),manim_lsp_CompletionProvider.kw("group","Group multiple filters"),manim_lsp_CompletionProvider.kw("none","Remove all filters")];
};
manim_lsp_CompletionProvider.paramTypeCompletions = function() {
	return [manim_lsp_CompletionProvider.kw("int","Integer parameter"),manim_lsp_CompletionProvider.kw("uint","Unsigned integer parameter"),manim_lsp_CompletionProvider.kw("float","Float parameter"),manim_lsp_CompletionProvider.kw("bool","Boolean parameter"),manim_lsp_CompletionProvider.kw("string","String parameter"),manim_lsp_CompletionProvider.kw("color","Color parameter (#RRGGBB)"),manim_lsp_CompletionProvider.kw("tile","Tile parameter (h2d.Tile)")];
};
...
manim_lsp_CompletionProvider.easingCompletions = function() {
	var easings = ["linear","easeIn","easeOut","easeInOut","easeInQuad","easeOutQuad","easeInOutQuad","easeInCubic","easeOutCubic","easeInOutCubic","easeInQuart","easeOutQuart","easeInOutQuart","easeInQuint","easeOutQuint","easeInOutQuint","easeInSine","easeOutSine","easeInOutSine","easeInExpo","easeOutExpo","easeInOutExpo","easeInCirc","easeOutCirc","easeInOutCirc","easeInBack","easeOutBack","easeInOutBack","easeInElastic","easeOutElastic","easeInOutElastic","easeInBounce","easeOutBounce","easeInOutBounce"];
	var _g = [];
	var _g1 = 0;
	while(_g1 < easings.length) {
		var e = easings[_g1];
		++_g1;
		_g.push({ label : e, kind : 20, detail : "Easing function"});
	}
	return _g;
};
...
manim_lsp_HoverProvider.lookupKeyword = function(word) {
	...
	case "animatedPath":
		return "**animatedPath** — Animated path with curves and events\n\n```manim\n#name animatedPath {\n  path: myPath\n  type: time\n  duration: 1.0\n  easing: easeOutCubic\n}\n```";
	case "apply":
		return "**apply** — Apply properties to parent element";
	case "bitmap":
		return "**bitmap** — Display an image\n\n```manim\nbitmap(source, [center])\nbitmap(\"sheet\", \"tile\")\nbitmap(file(\"image.png\"))\nbitmap(generated(color(w, h, #color)))\n```";
	case "blur":
		return "**blur** filter — `blur(radius, [gain, quality, linear])`";
	case "bool":
		return "**bool** — Boolean parameter type (true/false)";
	case "brightness":
		return "**brightness** filter — `brightness(value)` — 1.0 = normal";
	case "color":
		return "**color** — Color parameter type (#RRGGBB)";
	case "ctx":
	...
	case "curves":
		return "**curves** — Define curve functions\n\n```manim\ncurves {\n  #name curve { easing: easeInQuad }\n  #name curve { points: [(0,0), (1,1)] }\n  #name curve { multiply: [a, b] }\n}\n```";
	case "data":
		return "**data** — Static typed data block\n\n```manim\n#name data {\n  field:type = value\n}\n```";
	case "@default":case "default":
		return "**@default** — Final fallback (always matches)";
	case "dropShadow":
		return "**dropShadow** filter — `dropShadow(distance, angle, color, alpha, radius)`";
	case "dynamicRef":
		return "**dynamicRef** — Embed with runtime parameter updates\n\n```manim\ndynamicRef($ref, param1, param2)\n```";
	case "@else":case "else":
		return "**@else** — Matches when preceding @() condition didn't match\n\n```manim\n@(param=>value) element1\n@else element2\n@else(param=>other) element3\n```";
	case "@final":case "final":
		return "**@final** — Immutable named constant\n\n```manim\n@final NAME = 42\n// Use as $NAME\n```";
	case "float":
		return "**float** — Floating point parameter type";
	case "flow":
		return "**flow** — Layout flow container\n\n```manim\nflow(maxWidth, maxHeight, [layout]) {\n  // children...\n}\n```\n\nOptions: `overflow`, `fillWidth`, `fillHeight`, `reverse`, `horizontalAlign`, `verticalAlign`";
	case "glow":
		return "**glow** filter — `glow(color, alpha, radius, [gain, quality, smoothColor, knockout])`";
	case "graphics":
		return "**graphics** — Vector graphics drawing\n\n```manim\ngraphics(color, lineWidth) { line(x1,y1,x2,y2) }\n```";
	case "grayscale":
		return "**grayscale** filter — `grayscale(value)` — 0.0-1.0";
	case "grid":
	...
	case "hue":
		return "**hue** filter — `hue(degrees)`";
	case "import":
		return "**import** — Import external .manim file\n\n```manim\nimport \"file.manim\" as \"name\"\n```";
	case "int":
		return "**int** — Integer parameter type";
	case "interactive":
		return "**interactive** — Hit-test region\n\n```manim\ninteractive(width, height, id)\ninteractive(w, h, id, debug)\ninteractive(w, h, id, key => value, ...)\n```\n\nMetadata: `key => val`, `key:int => N`, `key:float => N`";
	case "layers":
		return "**layers** — Z-ordering container\n\nChildren use `layer: N` for ordering.";
	case "mask":
		return "**mask** — Clipping mask rectangle\n\n```manim\nmask(width, height) { ... }\n```";
	case "ninepatch":
		return "**ninepatch** — 9-patch scalable image\n\n```manim\nninepatch(sheet, tile, width, height)\n```";
	case "outline":
		return "**outline** filter — `outline(size, color)`";
	case "particles":
		return "**particles** — Particle effect system\n\n```manim\n#name particles {\n  count: 100\n  emit: point()\n  tiles: file(\"particle.png\")\n  maxLife: 2.0\n  speed: 50\n}\n```";
	case "paths":
		return "**paths** — Define path shapes\n\n```manim\npaths {\n  #name lineTo(x,y), bezier(cpx,cpy,ex,ey)\n}\n```";
	case "pixelOutline":
		return "**pixelOutline** filter — pixel-perfect outline";
	case "pixels":
		return "**pixels** — Pixel-level drawing primitives";
	case "placeholder":
		return "**placeholder** — Dynamic placeholder for runtime content\n\n```manim\nplaceholder(size, source)\n```";
	case "point":
		return "**point** — Positioning point for coordinate reference";
	case "programmable":
		return "**programmable** — Define a parameterized UI component\n\n```manim\n#name programmable(param:type=default) {\n  // elements...\n}\n```";
	case "repeatable":
		return "**repeatable** — Loop elements over an iterator\n\n```manim\nrepeatable($var, step(count, start, end)) { ... }\nrepeatable($var, layout(name)) { ... }\nrepeatable($var, array(a, b, c)) { ... }\n```";
	case "repeatable2d":
		return "**repeatable2d** — 2D loop\n\n```manim\nrepeatable2d($x, $y, iterX, iterY) { ... }\n```";
	case "replaceColor":
		return "**replaceColor** filter — `replaceColor: [#src1, #src2] => [#dst1, #dst2]`";
	case "replacePalette":
		return "**replacePalette** filter — replace palette colors";
	case "richText":
		return "**richText** — Rich text with [markup] (h2d.HtmlText)\n\n```manim\nrichText(font, \"content\", #color, [align, maxWidth])\n```\n\nAdditional options: `styles:`, `images:`, `condenseWhite`";
	case "saturate":
		return "**saturate** filter — `saturate(value)` — 1.0 = normal";
	case "settings":
		return "**settings** — Component settings block\n\n```manim\nsettings {\n  key:type => value\n}\n```";
	case "slot":
		return "**slot** — Swappable container\n\n```manim\n#name slot\n#name[$i] slot              // indexed\n#name slot(param:type=default) // parameterized\n```";
	case "spacer":
		return "**spacer** — Empty space inside flow containers\n\n```manim\nspacer(width, height)\n```";
	case "stateanim":
		return "**stateanim** — Inline state animation\n\n```manim\nstateanim construct(...)\n```";
	case "staticRef":
		return "**staticRef** — Embed another programmable (static, no runtime updates)\n\n```manim\nstaticRef($ref)\nstaticRef($ref, param1, param2)\n```";
	case "string":
		return "**string** — String parameter type";
	case "text":
		return "**text** — Simple text element (h2d.Text)\n\n```manim\ntext(font, \"content\", #color, [align, maxWidth])\n```\n\nOptions: `letterSpacing`, `lineSpacing`, `lineBreak`, `dropShadow*`, `autoFit`";
	case "tile":
		return "**tile** — Tile parameter type (h2d.Tile, no default allowed)";
	case "tilegroup":
		return "**tilegroup** — Optimized tile grouping container\n\nSupports: `bitmap`, `ninepatch`, `repeatable`, `pixels`, `point`";
	case "transition":
	...
	case "uint":
		return "**uint** — Unsigned integer parameter type (>= 0)";
	case "version":
		return "**version** — File version header\n\n```manim\nversion: 1.0\n```";
	default:
		return null;
	}
};
...
manim_lsp_LspTransport.prototype = {
	start: function() {
		var _gthis = this;
		manim_lsp_LspTransport.nodeProcess = process;
	...
	,send: function(msg) {
		var json = JSON.stringify(msg, function(k, v) { return (v === null && k !== '' && k !== 'result') ? undefined : v; });
...
manim_lsp_ManimAnalyzer.getDiagnostics = function(text,uri) {
	...
	try {
		...
		var unwrapped = (e && e.val) ? e.val : e;
		var error = unwrapped.error;
		var message = unwrapped.message;
		var msg = error != null ? error : message != null ? message : Std.string(e);
		var pos = unwrapped.pos;
		var posLine = pos != null ? pos.line : null;
		if(posLine != null) {
			var line = posLine;
			var col = pos.col;
			diagnostics.push({ range : { start : { line : line - 1, character : col - 1}, end : { line : line - 1, character : col}}, severity : 1, message : msg, source : "manim"});
		} else {
			var parsed = manim_lsp_ManimAnalyzer.parsePositionFromMessage(msg);
			diagnostics.push({ range : parsed.range, severity : 1, message : parsed.message, source : "manim"});
		}
	}
	return diagnostics;
};
manim_lsp_ManimAnalyzer.getSymbols = function(text,uri) {
	...
	try {
		...
		var keys = Object.keys(nodes.h);
		var _g = 0;
		while(_g < keys.length) {
			var name = keys[_g];
			++_g;
			var node = nodes.h[name];
			var range = manim_lsp_ManimAnalyzer.findNameInText(text,name);
			var nodeType = node.type;
			var typeName = nodeType._hx_name || ($hxEnums[nodeType.__enum__].__constructs__[nodeType._hx_index]._hx_name);
			var symbol;
			switch(typeName) {
			case "ANIMATED_PATH":
			...
			case "PATHS":
				...
				break;
			case "PROGRAMMABLE":
				var parameters = nodeType.parameters;
				var paramList = manim_lsp_ManimAnalyzer.getParamList(parameters);
...
manim_lsp_ManimAnalyzer.getParamList = function(parameters) {
	var result = [];
	var keys = Object.keys(parameters.h);
	var _g = 0;
	while(_g < keys.length) {
		var k = keys[_g];
		++_g;
		var v = parameters.h[k];
		result.push("" + k + ":" + manim_lsp_ManimAnalyzer.defTypeName(v.type));
	}
	return result;
};
manim_lsp_ManimAnalyzer.defTypeName = function(type) {
	var name = type._hx_name || ($hxEnums[type.__enum__].__constructs__[type._hx_index]._hx_name);
	switch(name) {
	case "PPTBool":
		return "bool";
	case "PPTColor":
	...
	case "PPTInt":
		return "int";
	case "PPTRange":
		return "" + Std.string(type.from) + ".." + Std.string(type.to);
	case "PPTString":
		return "string";
	case "PPTTile":
		return "tile";
...
manim_lsp_ManimAnalyzer.getChildSymbols = function(node,text) {
	...
	var _g = 0;
	while(_g < nodeChildren.length) {
		var child = nodeChildren[_g];
		++_g;
		var uname = child.updatableName;
		var unameName = uname._hx_name || ($hxEnums[uname.__enum__].__constructs__[uname._hx_index]._hx_name);
		if(unameName == "UNTName" || unameName == "UNTNameIndexed" || unameName == "UNTNameIndexed2D") {
			var name = uname.name;
			var range = manim_lsp_ManimAnalyzer.findNameInText(text,"#" + name);
			var childTypeName = child.type._hx_name || ($hxEnums[child.type.__enum__].__constructs__[child.type._hx_index]._hx_name);
			var kind = childTypeName == "SLOT" || childTypeName == "INTERACTIVE" ? 8 : 7;
			children.push({ name : "#" + name, kind : kind, range : range, selectionRange : range, detail : manim_lsp_ManimAnalyzer.nodeTypeLabel(childTypeName)});
		}
		var grandchildren = manim_lsp_ManimAnalyzer.getChildSymbols(child,text);
		if(grandchildren != null) {
			var _g1 = 0;
			while(_g1 < grandchildren.length) {
				var gc = grandchildren[_g1];
				++_g1;
				children.push(gc);
			}
		}
...
manim_lsp_ManimAnalyzer.nodeTypeLabel = function(name) {
	switch(name) {
	case "ANIMATED_PATH":
		return "animatedPath";
	case "APPLY":
	...
	case "SPACER":
		return "spacer";
	case "STATEANIM":case "STATEANIM_CONSTRUCT":
		return "stateanim";
	case "STATIC_REF":
		return "staticRef";
	case "TEXT":
...
manim_lsp_ManimAnalyzer.parsePositionFromMessage = function(msg) {
	var colonPattern = new EReg("(\\d+):\\s*character\\s+(\\d+)","");
	if(colonPattern.match(msg)) {
		var line = Std.parseInt(colonPattern.matched(1));
		var col = Std.parseInt(colonPattern.matched(2));
		if(line != null && col != null) {
			return { range : { start : { line : line - 1, character : col - 1}, end : { line : line - 1, character : col}}, message : msg};
		}
	}
	var simplePattern = new EReg(":(\\d+):(\\d+)","");
	if(simplePattern.match(msg)) {
		var line = Std.parseInt(simplePattern.matched(1));
		var col = Std.parseInt(simplePattern.matched(2));
		if(line != null && col != null) {
			return { range : { start : { line : line - 1, character : col - 1}, end : { line : line - 1, character : col}}, message : msg};
		}
	}
	return { range : { start : { line : 0, character : 0}, end : { line : 0, character : 1}}, message : msg};
};
manim_lsp_ManimAnalyzer.enumName = function(value) {
	return value._hx_name || ($hxEnums[value.__enum__].__constructs__[value._hx_index]._hx_name);
};
...
manim_lsp_ManimLanguageServer.prototype = {
	...
	,validateDocument: function(uri) {
		...
		var diagnostics = manim_lsp_ManimAnalyzer.getDiagnostics(text,uri);
	...
	,handleCompletion: function(id,params) {
		...
		var items = manim_lsp_ManimAnalyzer.getCompletions(text,line,character);
	...
	,handleHover: function(id,params) {
		...
		var line = params.position.line;
		var character = params.position.character;
		var hover = manim_lsp_ManimAnalyzer.getHover(text,uri,line,character);
	...
	,handleDocumentSymbol: function(id,params) {
		...
		var symbols = manim_lsp_ManimAnalyzer.getSymbols(text,uri);
