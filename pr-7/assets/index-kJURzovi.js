 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n($,R){var A=$.length;$.push(R);e:for(;0<A;){var j=A-1>>>1,O=$[j];if(0<i(O,R))$[j]=R,$[A]=O,A=j;else break e}}function t($){return $.length===0?null:$[0]}function r($){if($.length===0)return null;var R=$[0],A=$.pop();if(A!==R){$[0]=A;e:for(var j=0,O=$.length,le=O>>>1;j<le;){var ye=2*(j+1)-1,We=$[ye],dn=ye+1,Wn=$[dn];if(0>i(We,A))dn<O&&0>i(Wn,We)?($[j]=Wn,$[dn]=A,j=dn):($[j]=We,$[ye]=A,j=ye);else if(dn<O&&0>i(Wn,A))$[j]=Wn,$[dn]=A,j=dn;else break e}}return R}function i($,R){var A=$.sortIndex-R.sortIndex;return A!==0?A:$.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var o=Date,a=o.now();e.unstable_now=function(){return o.now()-a}}var u=[],d=[],v=1,m=null,p=3,h=!1,x=!1,w=!1,M=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,s=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f($){for(var R=t(d);R!==null;){if(R.callback===null)r(d);else if(R.startTime<=$)r(d),R.sortIndex=R.expirationTime,n(u,R);else break;R=t(d)}}function g($){if(w=!1,f($),!x)if(t(u)!==null)x=!0,V(_);else{var R=t(d);R!==null&&ue(g,R.startTime-$)}}function _($,R){x=!1,w&&(w=!1,c(C),C=-1),h=!0;var A=p;try{for(f(R),m=t(u);m!==null&&(!(m.expirationTime>R)||$&&!q());){var j=m.callback;if(typeof j=="function"){m.callback=null,p=m.priorityLevel;var O=j(m.expirationTime<=R);R=e.unstable_now(),typeof O=="function"?m.callback=O:m===t(u)&&r(u),f(R)}else r(u);m=t(u)}if(m!==null)var le=!0;else{var ye=t(d);ye!==null&&ue(g,ye.startTime-R),le=!1}return le}finally{m=null,p=A,h=!1}}var b=!1,E=null,C=-1,L=5,N=-1;function q(){return!(e.unstable_now()-N<L)}function Re(){if(E!==null){var $=e.unstable_now();N=$;var R=!0;try{R=E(!0,$)}finally{R?Se():(b=!1,E=null)}}else b=!1}var Se;if(typeof s=="function")Se=function(){s(Re)};else if(typeof MessageChannel<"u"){var rn=new MessageChannel,D=rn.port2;rn.port1.onmessage=Re,Se=function(){D.postMessage(null)}}else Se=function(){M(Re,0)};function V($){E=$,b||(b=!0,Se())}function ue($,R){C=M(function(){$(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function($){$.callback=null},e.unstable_continueExecution=function(){x||h||(x=!0,V(_))},e.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<$?Math.floor(1e3/$):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return t(u)},e.unstable_next=function($){switch(p){case 1:case 2:case 3:var R=3;break;default:R=p}var A=p;p=R;try{return $()}finally{p=A}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function($,R){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var A=p;p=$;try{return R()}finally{p=A}},e.unstable_scheduleCallback=function($,R,A){var j=e.unstable_now();switch(typeof A=="object"&&A!==null?(A=A.delay,A=typeof A=="number"&&0<A?j+A:j):A=j,$){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=A+O,$={id:v++,callback:R,priorityLevel:$,startTime:A,expirationTime:O,sortIndex:-1},A>j?($.sortIndex=A,n(d,$),t(u)===null&&$===t(d)&&(w?(c(C),C=-1):w=!0,ue(g,A-j))):($.sortIndex=O,n(u,$),x||h||(x=!0,V(_))),$},e.unstable_shouldYield=q,e.unstable_wrapCallback=function($){var R=p;return function(){var A=p;p=R;try{return $.apply(this,arguments)}finally{p=A}}}})(Ys);Xs.exports=Ys;var Md=Xs.exports;/**
 * @license React
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function _0(e,n,t){return n in e?Object.defineProperty(e,n,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[n]=t,e}function Ts(e,n){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);n&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),t.push.apply(t,r)}return t}function zs(e){for(var n=1;n<arguments.length;n++){var t=arguments[n]!=null?arguments[n]:{};n%2?Ts(Object(t),!0).forEach(function(r){_0(e,r,t[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):Ts(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r))})}return e}function S0(){for(var e=arguments.length,n=new Array(e),t=0;t<e;t++)n[t]=arguments[t];return function(r){return n.reduceRight(function(i,l){return l(i)},r)}}function Qt(e){return function n(){for(var t=this,r=arguments.length,i=new Array(r),l=0;l<r;l++)i[l]=arguments[l];return i.length>=e.length?e.apply(this,i):function(){for(var o=arguments.length,a=new Array(o),u=0;u<o;u++)a[u]=arguments[u];return n.apply(t,[].concat(i,a))}}}function $i(e){return{}.toString.call(e).includes("Object")}function b0(e){return!Object.keys(e).length}function wr(e){return typeof e=="function"}function C0(e,n){return Object.prototype.hasOwnProperty.call(e,n)}function E0(e,n){return $i(n)||Dn("changeType"),Object.keys(n).some(function(t){return!C0(e,t)})&&Dn("changeField"),n}function P0(e){wr(e)||Dn("selectorType")}function F0(e){wr(e)||$i(e)||Dn("handlerType"),$i(e)&&Object.values(e).some(function(n){return!wr(n)})&&Dn("handlersType")}function N0(e){e||Dn("initialIsRequired"),$i(e)||Dn("initialType"),b0(e)&&Dn("initialContent")}function $0(e,n){throw new Error(e[n]||e.default)}var T0={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},Dn=Qt($0)(T0),Hr={changes:E0,selector:P0,handler:F0,initial:N0};function z0(e){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};Hr.initial(e),Hr.handler(n);var t={current:e},r=Qt(R0)(t,n),i=Qt(M0)(t),l=Qt(Hr.changes)(e),o=Qt(j0)(t);function a(){var d=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(v){return v};return Hr.selector(d),d(t.current)}function u(d){S0(r,i,l,o)(d)}return[a,u]}function j0(e,n){return wr(n)?n(e.current):n}function M0(e,n){return e.current=zs(zs({},e.current),n),n}function R0(e,n,t){return wr(n)?n(e.current):Object.keys(t).forEach(function(r){var i;return(i=n[r])===null||i===void 0?void 0:i.call(n,e.current[r])}),t}var L0={create:z0},D0={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.52.2/min/vs"}};function O0(e){return function n(){for(var t=this,r=arguments.length,i=new Array(r),l=0;l<r;l++)i[l]=arguments[l];return i.length>=e.length?e.apply(this,i):function(){for(var o=arguments.length,a=new Array(o),u=0;u<o;u++)a[u]=arguments[u];return n.apply(t,[].concat(i,a))}}}function I0(e){return{}.toString.call(e).includes("Object")}function A0(e){return e||js("configIsRequired"),I0(e)||js("configType"),e.urls?(B0(),{paths:{vs:e.urls.monacoBase}}):e}function B0(){console.warn(Xc.deprecation)}function U0(e,n){throw new Error(e[n]||e.default)}var Xc={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},js=O0(U0)(Xc),W0={config:A0},H0=function(){for(var n=arguments.length,t=new Array(n),r=0;r<n;r++)t[r]=arguments[r];return function(i){return t.reduceRight(function(l,o){return o(l)},i)}};function Yc(e,n){return Object.keys(n).forEach(function(t){n[t]instanceof Object&&e[t]&&Object.assign(n[t],Yc(e[t],n[t]))}),Ns(Ns({},e),n)}var V0={type:"cancelation",msg:"operation is manually canceled"};function _l(e){var n=!1,t=new Promise(function(r,i){e.then(function(l){return n?i(V0):r(l)}),e.catch(i)});return t.cancel=function(){return n=!0},t}var Q0=L0.create({config:D0,isInitialized:!1,resolve:null,reject:null,monaco:null}),Zc=v0(Q0,2),Er=Zc[0],Gi=Zc[1];function G0(e){var n=W0.config(e),t=n.monaco,r=g0(n,["monaco"]);Gi(function(i){return{config:Yc(i.config,r),monaco:t}})}function K0(){var e=Er(function(n){var t=n.monaco,r=n.isInitialized,i=n.resolve;return{monaco:t,isInitialized:r,resolve:i}});if(!e.isInitialized){if(Gi({isInitialized:!0}),e.monaco)return e.resolve(e.monaco),_l(Sl);if(window.monaco&&window.monaco.editor)return qc(window.monaco),e.resolve(window.monaco),_l(Sl);H0(X0,Z0)(q0)}return _l(Sl)}function X0(e){return document.body.appendChild(e)}function Y0(e){var n=document.createElement("script");return e&&(n.src=e),n}function Z0(e){var n=Er(function(r){var i=r.config,l=r.reject;return{config:i,reject:l}}),t=Y0("".concat(n.config.paths.vs,"/loader.js"));return t.onload=function(){return e()},t.onerror=n.reject,t}function q0(){var e=Er(function(t){var r=t.config,i=t.resolve,l=t.reject;return{config:r,resolve:i,reject:l}}),n=window.require;n.config(e.config),n(["vs/editor/editor.main"],function(t){qc(t),e.resolve(t)},function(t){e.reject(t)})}function qc(e){Er().monaco||Gi({monaco:e})}function J0(){return Er(function(e){var n=e.monaco;return n})}var Sl=new Promise(function(e,n){return Gi({resolve:e,reject:n})}),Jc={config:G0,init:K0,__getMonacoInstance:J0},em={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},bl=em,nm={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},tm=nm;function rm({children:e}){return he.createElement("div",{style:tm.container},e)}var im=rm,lm=im;function om({width:e,height:n,isEditorReady:t,loading:r,_ref:i,className:l,wrapperProps:o}){return he.createElement("section",{style:{...bl.wrapper,width:e,height:n},...o},!t&&he.createElement(lm,null,r),he.createElement("div",{ref:i,style:{...bl.fullWidth,...!t&&bl.hide},className:l}))}var am=om,ed=P.memo(am);function sm(e){P.useEffect(e,[])}var nd=sm;function um(e,n,t=!0){let r=P.useRef(!0);P.useEffect(r.current||!t?()=>{r.current=!1}:e,n)}var De=um;function tr(){}function vt(e,n,t,r){return cm(e,r)||dm(e,n,t,r)}function cm(e,n){return e.editor.getModel(td(e,n))}function dm(e,n,t,r){return e.editor.createModel(n,t,r?td(e,r):void 0)}function td(e,n){return e.Uri.parse(n)}function fm({original:e,modified:n,language:t,originalLanguage:r,modifiedLanguage:i,originalModelPath:l,modifiedModelPath:o,keepCurrentOriginalModel:a=!1,keepCurrentModifiedModel:u=!1,theme:d="light",loading:v="Loading...",options:m={},height:p="100%",width:h="100%",className:x,wrapperProps:w={},beforeMount:M=tr,onMount:c=tr}){let[s,f]=P.useState(!1),[g,_]=P.useState(!0),b=P.useRef(null),E=P.useRef(null),C=P.useRef(null),L=P.useRef(c),N=P.useRef(M),q=P.useRef(!1);nd(()=>{let D=Jc.init();return D.then(V=>(E.current=V)&&_(!1)).catch(V=>(V==null?void 0:V.type)!=="cancelation"&&console.error("Monaco initialization: error:",V)),()=>b.current?rn():D.cancel()}),De(()=>{if(b.current&&E.current){let D=b.current.getOriginalEditor(),V=vt(E.current,e||"",r||t||"text",l||"");V!==D.getModel()&&D.setModel(V)}},[l],s),De(()=>{if(b.current&&E.current){let D=b.current.getModifiedEditor(),V=vt(E.current,n||"",i||t||"text",o||"");V!==D.getModel()&&D.setModel(V)}},[o],s),De(()=>{let D=b.current.getModifiedEditor();D.getOption(E.current.editor.EditorOption.readOnly)?D.setValue(n||""):n!==D.getValue()&&(D.executeEdits("",[{range:D.getModel().getFullModelRange(),text:n||"",forceMoveMarkers:!0}]),D.pushUndoStop())},[n],s),De(()=>{var D,V;(V=(D=b.current)==null?void 0:D.getModel())==null||V.original.setValue(e||"")},[e],s),De(()=>{let{original:D,modified:V}=b.current.getModel();E.current.editor.setModelLanguage(D,r||t||"text"),E.current.editor.setModelLanguage(V,i||t||"text")},[t,r,i],s),De(()=>{var D;(D=E.current)==null||D.editor.setTheme(d)},[d],s),De(()=>{var D;(D=b.current)==null||D.updateOptions(m)},[m],s);let Re=P.useCallback(()=>{var ue;if(!E.current)return;N.current(E.current);let D=vt(E.current,e||"",r||t||"text",l||""),V=vt(E.current,n||"",i||t||"text",o||"");(ue=b.current)==null||ue.setModel({original:D,modified:V})},[t,n,i,e,r,l,o]),Se=P.useCallback(()=>{var D;!q.current&&C.current&&(b.current=E.current.editor.createDiffEditor(C.current,{automaticLayout:!0,...m}),Re(),(D=E.current)==null||D.editor.setTheme(d),f(!0),q.current=!0)},[m,d,Re]);P.useEffect(()=>{s&&L.current(b.current,E.current)},[s]),P.useEffect(()=>{!g&&!s&&Se()},[g,s,Se]);function rn(){var V,ue,$,R;let D=(V=b.current)==null?void 0:V.getModel();a||((ue=D==null?void 0:D.original)==null||ue.dispose()),u||(($=D==null?void 0:D.modified)==null||$.dispose()),(R=b.current)==null||R.dispose()}return he.createElement(ed,{width:h,height:p,isEditorReady:s,loading:v,_ref:C,className:x,wrapperProps:w})}var pm=fm;P.memo(pm);function mm(e){let n=P.useRef();return P.useEffect(()=>{n.current=e},[e]),n.current}var hm=mm,Vr=new Map;function gm({defaultValue:e,defaultLanguage:n,defaultPath:t,value:r,language:i,path:l,theme:o="light",line:a,loading:u="Loading...",options:d={},overrideServices:v={},saveViewState:m=!0,keepCurrentModel:p=!1,width:h="100%",height:x="100%",className:w,wrapperProps:M={},beforeMount:c=tr,onMount:s=tr,onChange:f,onValidate:g=tr}){let[_,b]=P.useState(!1),[E,C]=P.useState(!0),L=P.useRef(null),N=P.useRef(null),q=P.useRef(null),Re=P.useRef(s),Se=P.useRef(c),rn=P.useRef(),D=P.useRef(r),V=hm(l),ue=P.useRef(!1),$=P.useRef(!1);nd(()=>{let j=Jc.init();return j.then(O=>(L.current=O)&&C(!1)).catch(O=>(O==null?void 0:O.type)!=="cancelation"&&console.error("Monaco initialization: error:",O)),()=>N.current?A():j.cancel()}),De(()=>{var O,le,ye,We;let j=vt(L.current,e||r||"",n||i||"",l||t||"");j!==((O=N.current)==null?void 0:O.getModel())&&(m&&Vr.set(V,(le=N.current)==null?void 0:le.saveViewState()),(ye=N.current)==null||ye.setModel(j),m&&((We=N.current)==null||We.restoreViewState(Vr.get(l))))},[l],_),De(()=>{var j;(j=N.current)==null||j.updateOptions(d)},[d],_),De(()=>{!N.current||r===void 0||(N.current.getOption(L.current.editor.EditorOption.readOnly)?N.current.setValue(r):r!==N.current.getValue()&&($.current=!0,N.current.executeEdits("",[{range:N.current.getModel().getFullModelRange(),text:r,forceMoveMarkers:!0}]),N.current.pushUndoStop(),$.current=!1))},[r],_),De(()=>{var O,le;let j=(O=N.current)==null?void 0:O.getModel();j&&i&&((le=L.current)==null||le.editor.setModelLanguage(j,i))},[i],_),De(()=>{var j;a!==void 0&&((j=N.current)==null||j.revealLine(a))},[a],_),De(()=>{var j;(j=L.current)==null||j.editor.setTheme(o)},[o],_);let R=P.useCallback(()=>{var j;if(!(!q.current||!L.current)&&!ue.current){Se.current(L.current);let O=l||t,le=vt(L.current,r||e||"",n||i||"",O||"");N.current=(j=L.current)==null?void 0:j.editor.create(q.current,{model:le,automaticLayout:!0,...d},v),m&&N.current.restoreViewState(Vr.get(O)),L.current.editor.setTheme(o),a!==void 0&&N.current.revealLine(a),b(!0),ue.current=!0}},[e,n,t,r,i,l,d,v,m,o,a]);P.useEffect(()=>{_&&Re.current(N.current,L.current)},[_]),P.useEffect(()=>{!E&&!_&&R()},[E,_,R]),D.current=r,P.useEffect(()=>{var j,O;_&&f&&((j=rn.current)==null||j.dispose(),rn.current=(O=N.current)==null?void 0:O.onDidChangeModelContent(le=>{$.current||f(N.current.getValue(),le)}))},[_,f]),P.useEffect(()=>{if(_){let j=L.current.editor.onDidChangeMarkers(O=>{var ye;let le=(ye=N.current.getModel())==null?void 0:ye.uri;if(le&&O.find(We=>We.path===le.path)){let We=L.current.editor.getModelMarkers({resource:le});g==null||g(We)}});return()=>{j==null||j.dispose()}}return()=>{}},[_,g]);function A(){var j,O;(j=rn.current)==null||j.dispose(),p?m&&Vr.set(l,N.current.saveViewState()):(O=N.current.getModel())==null||O.dispose(),N.current.dispose()}return he.createElement(ed,{width:h,height:x,isEditorReady:_,loading:u,_ref:q,className:w,wrapperProps:M})}var vm=gm,ym=P.memo(vm),xm=ym;const wm=[{include:"#strings"},{name:"comment.line.double-slash",match:"//.*$"},{include:"#keywords"}],km={keywords:{patterns:[{name:"entity.name.class",match:"\\b(sheet|allowedExtraPoints|states|center)\\b"},{name:"keyword",match:"\\b(animation)\\b"},{name:"entity.name.type",match:"\\b(name|fps|playlist|sheet|extrapoints|playlist|loop|event|goto|hit|random|trigger|command|frames|untilCommand|duration|file)\\b"}]},strings:{name:"string.quoted.double",begin:'"',end:'"',patterns:[{name:"constant.character.escape.multianim",match:"\\\\."}]}},_m={patterns:wm,repository:km},Sm=[{include:"#strings"},{name:"comment.line.double-slash",match:"//.*$"},{name:"variable.name",match:"\\$[A-Za-z][A-Za-z0-9]*"},{name:"entity.name.tag",match:"#[A-Za-z][A-Za-z0-9\\-]*\\b"},{begin:"(@|@if|@ifstrict)\\(",beginCaptures:{0:{name:"keyword.control.at-sign"}},end:"\\)",endCaptures:{0:{name:"keyword.control.parenthesis"}},name:"meta.condition-block",contentName:"meta.condition-content",patterns:[{match:"\\b([A-Za-z_][A-Za-z0-9_]*)\\s*=>",name:"meta.condition-pair",captures:{0:{name:"keyword.other"},1:{name:"variable.other.key"}}},{match:"([A-Za-z_][A-Za-z0-9_]*)",name:"constant.other.value"},{match:",",name:"punctuation.separator.comma"}]},{name:"entity.name.method",match:"\\b@[A-Za-z][A-Za-z0-9]*\\b"},{include:"#keywords"}],bm={keywords:{patterns:[{name:"entity.name.class",match:"\\b(animatedPath|particles|programmable|stateanim|flow|apply|text|tilegroup|repeatable|ninepatch|layers|placeholder|reference|bitmap|point|interactive|pixels|relativeLayouts|palettes|paths)\\b"},{name:"keyword",match:"\\b(external|path|debug|version|nothing|list|line|flat|pointy|layer|layout|callback|builderParam|tileSource|sheet|file|generated|hex|hexCorner|hexEdge|grid|settings|pos|alpha|blendMode|scale|updatable|cross|function|gridWidth|gridHeight|center|left|right|top|bottom|offset|construct|palette|position|import|filter)\\b"},{name:"entity.name.type",match:"\\b(int|uint|flags|string|hexdirection|griddirection|bool|color)\\b"},{name:"entity.name.type",match:"\\b(int|uint|flags|string|hexdirection|griddirection|bool|color)\\b"}]},strings:{name:"string.quoted.double",begin:'"',end:'"',patterns:[{name:"constant.character.escape.multianim",match:"\\\\."}]}},Cm={patterns:Sm,repository:bm},Ms=e=>{const n={root:[]};return e.patterns&&e.patterns.forEach(t=>{if(t.include){const r=t.include.replace("#","");e.repository&&e.repository[r]&&e.repository[r].patterns.forEach(l=>{l.match&&n.root.push([new RegExp(l.match),l.name||"identifier"])})}else t.match&&n.root.push([new RegExp(t.match),t.name||"identifier"])}),e.repository&&Object.keys(e.repository).forEach(t=>{const r=e.repository[t];r.patterns&&(n[t]=r.patterns.map(i=>i.match?[new RegExp(i.match),i.name||"identifier"]:["",""]).filter(([i])=>i!==""))}),n},rd=P.forwardRef(({value:e,onChange:n,language:t="text",disabled:r=!1,placeholder:i,onSave:l,errorLine:o,errorColumn:a,errorStart:u,errorEnd:d},v)=>{const m=P.useRef(null),p=P.useRef(),h=P.useRef([]);P.useEffect(()=>{p.current=l},[l]),P.useEffect(()=>{if(m.current&&(h.current.length>0&&(m.current.deltaDecorations(h.current,[]),h.current=[]),o)){const c=[];if(c.push({range:{startLineNumber:o,startColumn:1,endLineNumber:o,endColumn:1},options:{isWholeLine:!0,className:"error-line",glyphMarginClassName:"error-glyph",linesDecorationsClassName:"error-line-decoration"}}),u!==void 0&&d!==void 0){const s=m.current.getModel();if(s)try{const f=s.getPositionAt(u),g=s.getPositionAt(d);c.push({range:{startLineNumber:f.lineNumber,startColumn:f.column,endLineNumber:g.lineNumber,endColumn:g.column},options:{className:"error-token",hoverMessage:{value:"Parse error at this position"}}})}catch(f){console.log("Error calculating character position:",f)}}h.current=m.current.deltaDecorations([],c)}},[o,a,u,d]);const x=(c,s)=>{m.current=c,s.languages.register({id:"haxe-anim"}),s.languages.register({id:"haxe-manim"});const f=Ms(_m);s.languages.setMonarchTokensProvider("haxe-anim",{tokenizer:f});const g=Ms(Cm);s.languages.setMonarchTokensProvider("haxe-manim",{tokenizer:g}),c.addAction({id:"save-file",label:"Save File",keybindings:[s.KeyMod.CtrlCmd|s.KeyCode.KeyS],run:()=>{p.current&&p.current()}}),c.focus()},w=c=>{c!==void 0&&n(c)},M=()=>t==="typescript"&&(e.includes("class")||e.includes("function")||e.includes("var"))?"haxe-manim":t;return y.jsxs("div",{ref:v,className:"w-full h-full min-h-[200px] border border-zinc-700 rounded overflow-hidden",style:{minHeight:200},children:[y.jsx("style",{children:`
          .error-line {
