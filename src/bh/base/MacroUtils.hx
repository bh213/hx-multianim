...
class MacroUtils {
    ...
    public static macro function macroBuildWithParameters(builder:Expr, builderName:ExprOf<String>, inputParams:Expr, builderParams:Expr):Expr {
        ...
        final uiScreenBase = haxe.macro.ComplexTypeTools.toType(macro:bh.ui.screens.UIScreen.UIScreenBase);
                                            ...
                                            switch funcType {
                                                case TFun(args, ret):
                                                    ...
                                                    for (index => value in args) {
                                                        switch value.t {
                                                            case TType(t, params):
                                                                var settings = haxe.macro.Context.getType("bh.multianim.MultiAnimParser.ResolvedSettings");
