...
import wt.multianim.MultiAnimParser.GeneratedTileType;
import wt.multianim.MultiAnimParser.PlaceholderTypes;
import h2d.Font;
...
interface ResourceLoader {
    function loadSheet2(sheetName:String):wt.base.Atlas2;
