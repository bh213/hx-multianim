...
import wt.multianim.MultiAnimParser.BuiltHeapsComponent;
import wt.multianim.MultiAnimParser.ParticlesDef;
...
class AnimatedPath {
    ...
    public function calculatePosition():wt.base.FPoint {
