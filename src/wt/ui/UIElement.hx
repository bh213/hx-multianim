...
import wt.ui.UIMultiAnimDropdown;
...
interface UIElementCustomAddToLayer {
	...
	function customAddToLayer(requestedLayer:Null<wt.ui.screens.UIScreen.LayersEnum>, screen:wt.ui.screens.UIScreen, updateMode:Bool):UIElementCustomAddToLayerResult;
}
