...
@:nullSafety
class UIStandardMultiCheckbox implements UIElement implements UIElementDisablable implements UIElementSelectable implements StandardUIElementEvents implements  UIElementNumberValue implements UIElementSyncRedraw{
    ...
    public function doRedraw() {
        ...
        if (this.checkboxObject != null) this.checkboxObject.remove();
    ...
    @:allow(wt.ui.UIMultiAnimRadioButtons)
