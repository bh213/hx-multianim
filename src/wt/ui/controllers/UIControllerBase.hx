package wt.ui.controllers;

import wt.ui.UIElement;
//import wt.ui.controllers.UIController.EventWrapper;
...
abstract class UIControllerBase implements UIController  {
    ...
    final integration:wt.ui.controllers.UIController.UIControllerScreenIntegration;
